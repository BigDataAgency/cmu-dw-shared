...
export const ordersApi = {
  ...
  getById: (id: string): Promise<Order> => get(`/orders/${id}`),
  ...
  ): Promise<{ order_id: string; project_name: string | null }> =>
    patch(`/orders/${id}/project-name`, { project_name: projectName }),

  updateStatus: (
    id: string,
    payload: UpdateOrderStatusPayload
  ): Promise<unknown> => patch(`/orders/${id}/status`, payload),

  returnBottles: (
    id: string,
    payload: ReturnBottlesPayload
  ): Promise<unknown> => post(`/orders/${id}/return-bottles`, payload),
  ...
  datesCapacity: (
    payload: DatesCapacityPayload
  ): Promise<DatesCapacityResult> => post("/orders/dates-capacity", payload),
  ...
  ): Promise<OrderCreditNote> => post(`/orders/${id}/credit-notes`, payload),
};
