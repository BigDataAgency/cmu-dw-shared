...
declare const documentsApi: {
    ...
    void: (id: string, reason: string) => Promise<{
        success: boolean;
    }>;
...
declare const disbursementsApi: {
    ...
    setAgencyApprovalTemplate: (agencyId: string, steps: ApproverInput[]) => Promise<{
        steps_saved: number;
    }>;
...
declare const treasuryApi: {
    ...
    stockLevels: () => Promise<StockLevelRow[]>;
